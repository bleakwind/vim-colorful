...
"
" +----------------------------------------------------------------------+
" | $Id: bwdark.vim 2018-04-06 14:28:29Z Bleakwind $                     |
" +----------------------------------------------------------------------+
" | Copyright (c) 2008-2018 Bleakwind(Rick Woo).                         |
" +----------------------------------------------------------------------+
" | This source file is bwdark.vim.                                      |
...
hi CursorLine                           ctermfg=NONE        ctermbg=DarkRed     cterm=NONE        guifg=NONE      guibg=#2C323C   gui=NONE
hi CursorColumn                         ctermfg=NONE        ctermbg=DarkRed     cterm=NONE        guifg=NONE      guibg=#2C323C   gui=NONE
...
hi Visual                               ctermfg=White       ctermbg=Brown       cterm=NONE        guifg=#FFFFFF   guibg=#6A5ACD   gui=NONE
hi VisualNOS                            ctermfg=White       ctermbg=Brown       cterm=Underline   guifg=#FFFFFF   guibg=#6A5ACD   gui=Underline
