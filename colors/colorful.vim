...
hi lCursor                          ctermfg=Black       ctermbg=Blue        cterm=NONE      guifg=#000000   guibg=#573DBF   gui=NONE
...
hi Visual                           ctermfg=White       ctermbg=Blue        cterm=NONE      guifg=#FFFFFF   guibg=#573DBF   gui=NONE
hi VisualNOS                        ctermfg=White       ctermbg=Blue        cterm=Underline guifg=#FFFFFF   guibg=#573DBF   gui=Underline
...
hi QuickFixLine                     ctermfg=White       ctermbg=Blue        cterm=NONE      guifg=#FFFFFF   guibg=#573DBF   gui=NONE
...
hi PmenuSel                         ctermfg=White       ctermbg=Blue        cterm=NONE      guifg=#FFFFFF   guibg=#573DBF   gui=NONE
hi PmenuMatchSel                    ctermfg=White       ctermbg=Blue        cterm=NONE      guifg=#FFFFFF   guibg=#573DBF   gui=NONE
hi PmenuKindSel                     ctermfg=White       ctermbg=Blue        cterm=NONE      guifg=#FFFFFF   guibg=#573DBF   gui=NONE
hi PmenuExtraSel                    ctermfg=White       ctermbg=Blue        cterm=NONE      guifg=#FFFFFF   guibg=#573DBF   gui=NONE
hi ComplMatchIns                    ctermfg=White       ctermbg=Blue        cterm=NONE      guifg=#FFFFFF   guibg=#573DBF   gui=NONE
hi PopupNotification                ctermfg=Black       ctermbg=LightGray   cterm=NONE      guifg=#000000   guibg=#A9A9A9   gui=NONE
hi PopupSelected                    ctermfg=White       ctermbg=Blue        cterm=NONE      guifg=#FFFFFF   guibg=#573DBF   gui=NONE
